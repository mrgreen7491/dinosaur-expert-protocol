...
const SUBTITLES: SubtitleLine[] = [
 { start: 0.0, end: 3.5, en: "Welcome... to the Dino World!", ja: "恐竜の世界へ、ようこそ。" },
  ...
  { start: 14.0, end: 20.0, en: "Your ultimate adventure begins now!", ja: "究極（きゅうきょく）の冒険が、ここから始まる。" }
];
            ...
            <div className="relative z-10 flex flex-col items-center gap-6 my-auto">
              ...
              <div className="flex flex-col gap-2">
                <span className="text-xs font-mono text-emerald-400 tracking-widest uppercase">
                  CINEMATIC PRE-RENDER IN PROGRESS [{currentTime.toFixed(1)}s / 20.0s]
                </span>
                <div className="w-48 h-1.5 bg-slate-800 rounded-full mx-auto overflow-hidden">
                  <div 
                    className="h-full bg-emerald-400 transition-all duration-100"
                    style={{ width: `${Math.min(100, (currentTime / 20.0) * 100)}%` }}
                  />
                </div>
              </div>
            </div>
